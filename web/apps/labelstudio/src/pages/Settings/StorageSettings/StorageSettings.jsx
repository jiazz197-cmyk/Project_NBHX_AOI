import { Button, EmptyState, SimpleCard, Spinner, Typography } from "@humansignal/ui";
import { IconCloudCustom, IconExternal } from "@humansignal/icons";
...
export const StorageSettings = () => {
  ...
  useUpdatePageTitle(createTitleFromSegments([project?.title, "Storage Settings"]));
    ...
    <section className="max-w-[680px]">
      ...
      {hasAnyStorages && (
        <Typography size="small" className="text-neutral-content-subtler mb-wider">
          Use local files as the source for your labeling tasks or the target of your completed annotations.
        </Typography>
      )}
      ...
      {!hasAnyStorages && isLoaded && !isLoading && (
        <SimpleCard title="" className="bg-primary-background border-primary-border-subtler p-base">
          <EmptyState
            ...
            description="Use local files as the source for your labeling tasks or the target of your completed annotations."
              ...
              !window.APP_SETTINGS?.whitelabel_is_active && (
                <Typography variant="label" size="small" className="text-primary-link">
                  <a
                    ...
                    aria-label="Learn more about storage (opens in new window)"
